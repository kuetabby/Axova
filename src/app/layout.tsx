...
const app_title = "Axova - Unlocking Real-Time Insights with AI";
const app_name = "Axova - Unlocking Real-Time Insights with AI";
const description = "Unlocking Real-Time Insights with AI";
